...
import {
    candidateOnboardFormControls, initialCandidateAccountFormData,
            ...
            <div className="py-20 pb-24 pt-6">
                <div className="container mx-auto p-0 space-y-8">
                    <CommonForm
                        ...
                        formControls={
                            profileInfo?.role === "candidate" ? candidateOnboardFormControls.filter(
                                formControl => formControl.name !== "resume") : recruiterOnboardFormControls
                        }
                        formData={
