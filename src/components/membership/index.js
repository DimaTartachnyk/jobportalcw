...
const stripePromise = loadStripe("pk_test_51PUYbWCs15AoheAEHiM64LlxPAkFuJhhyOYxGkkYqeXjmQaAqmLpLIJY8jojNdSGGKisZKoL7VDE6iEOB420MWTI00LWUUbTox")
        ...
        await updateProfileAction(
            {
                ...
                memberShipEndDate: new Date(new Date().getFullYear() +
                    fetchCurrentPlanFromSessionStorage?.type ===
                    "basic" ? 1 : fetchCurrentPlanFromSessionStorage?.plan === "teams" ? 2 : 5,
                    new Date().getMonth(),
                    new Date().getDay()
                ),
            },
